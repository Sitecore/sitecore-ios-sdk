...
**Link to download complete** [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
...
**Link to download** [Sitecore Mobile SDK server](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/package.zip?raw=true) **package**
...
**Link to download** [SitecoreMobileSDK.framework](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SitecoreMobileSDK.framework.zip?raw=true)
...
The Sitecore Mobile SDK contains the SCWebView classes that extend the WebView class with additional features such as sharing on Twitter and left-right swiping. For more information, see the chapter Using the Enhanced Web View Reference: [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true).
...
For a complete list of the features that are available in the Embedded Web View, see the chapter Using the Enhanced Web View Reference: [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true).
...
For more information, see the section Installing the Client Side. [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
...
**For more information, see the section Accessing an Item.** [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
...
Access an Item.** [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
...
**For more information, see the section Accessing the Fields of an Item.** [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
...
**For more information, see the section Accessing the Children of an Item.** [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
...
**For more information, see the section Populating the Tab Bar.** [Mobile SDK documentation PDF](https://github.com/Sitecore/sitecore-mobile-sdk/blob/master/download/SC_Mobile_SDK_Developer_Guide_SC65-66-USLetter.pdf?raw=true)
