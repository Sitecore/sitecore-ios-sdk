...
-(void)testReadNotAllowedItemWithAllFields
{
    ...
    @autoreleasepool
    {
        ...
        {
            strongContext_ = apiContext_ = [ TestingRequestFactory getNewAdminContextWithShell ];
            apiContext_ = strongContext_;
            
            SCReadItemsRequest* request_ = [ SCReadItemsRequest requestWithItemPath: not_allowed_path_
                                                                            fieldsNames: nil ];
...
-(void)testReadAllowedItemWithSomeFields
{
    ...
    @autoreleasepool
    {
        ...
        void (^block_)(JFFSimpleBlock) = ^void( JFFSimpleBlock didFinishCallback_ )
        {
            ...
            SCReadItemsRequest* request_ = [ SCReadItemsRequest requestWithItemPath: allowed_path_
...
-(void)testReadItemSWithNoFields
{
    ...
    @autoreleasepool
    {
        ...
        void (^block_)(JFFSimpleBlock) = ^void( JFFSimpleBlock didFinishCallback_ )
        {
            ...
            {
                items_ = result_items_;
                SCReadItemsRequest* parent_request_ = [ SCReadItemsRequest requestWithItemPath: not_allowed_path_
                                                                                       fieldsNames: [ NSSet new ] ];
                [ apiContext_ readItemsOperationWithRequest: parent_request_ ]( ^( NSArray* result_items_parent_, NSError* error_ )
                {
