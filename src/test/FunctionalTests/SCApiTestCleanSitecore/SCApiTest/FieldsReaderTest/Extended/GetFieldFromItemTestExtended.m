...
@interface GetFieldFromItemTestExtended : SCAsyncTestCase
@end

@implementation GetFieldFromItemTestExtended
...
-(void)testImageLoaderForSCMediaPath
{
    ...
    void (^block_)(JFFSimpleBlock) = ^void( JFFSimpleBlock didFinishCallback_ )
    {
        @autoreleasepool
        {
            ...
            [ apiContext_.extendedApiSession downloadResourceOperationForMediaPath: @"~/media/Images/test image"
                                                           imageParams: nil ];
            loader(nil, nil, doneHandler);
    ...
    void (^block_)(JFFSimpleBlock) = ^void( JFFSimpleBlock didFinishCallback_ )
    {
        @autoreleasepool
        {
            ...
            SCDidFinishAsyncOperationHandler doneHandler = ^( id result_, NSError* error_ )
            {
                ...
                SCDidFinishAsyncOperationHandler doneHandler1 = ^( id field_result_, NSError* error_ )
                {
