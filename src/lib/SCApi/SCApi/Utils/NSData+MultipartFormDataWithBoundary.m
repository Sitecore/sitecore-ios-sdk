                            ...
                            contentType:( NSString* )contentType_
{
    ...
    NSString* boundaryPost_ = [ NSString stringWithFormat: @"\r\n--%@\r\n", boundary_ ];
    ...
    NSString* contentDesp_ = [ NSString stringWithFormat: contentDespFormat_, fileName_ ];

    [ result_ appendData: [ contentDesp_ dataUsingEncoding: NSUTF8StringEncoding ] ];

    static NSString* const contentTypeFormat_ =
        @"Content-Type: %@\r\n\r\n";
    NSString* contentTypeStr_ = [ NSString stringWithFormat: contentTypeFormat_, contentType_ ];
