...
@implementation SCUploadMediaItemRequest

-(id)copyWithZone:( NSZone* )zone_
{
    SCUploadMediaItemRequest * result_ = [ [ [ self class ] allocWithZone: zone_ ] init ];
...
-(BOOL)isEqual:( SCUploadMediaItemRequest * )other_
{
    if ( other_ == self )
    {
        return YES;
...
-(BOOL)isEqualToCreateMediaItemRequest:( SCUploadMediaItemRequest * )other_
{
    if ( self == other_ )
    {
        return YES;
