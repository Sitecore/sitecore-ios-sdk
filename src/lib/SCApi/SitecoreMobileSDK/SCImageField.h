...
/**
 The path to the Sitecore media item's image. Can be used to read an image, see [SCApiSession uploadOperationForSCMediaPath:] or [SCImageField readFieldValueOperation]
 */
